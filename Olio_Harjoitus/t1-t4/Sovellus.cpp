...
//	file.open("Tiedot.csv");
	...
	do
	{
		...
		{
			testi.lisaaKoulutusohjelmaanOpiskelija(); // Opiskelijatiedot lisätään cvs fileen opiskelija.cpp:ssä, täytyy tehdä erillinen toiminto?
			do {
				cout << " Paina valilyontia jatkaaksesi " << endl;
		...
		{
			testi.poistaKoulutusOhjelma(); // täälä nyt
